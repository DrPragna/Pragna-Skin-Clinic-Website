...
import { Condition, TreatmentFamily, ConditionContent } from '@/lib/navigationData';
import MobileConditionPage from './MobileConditionPage';
...
interface ConditionPageClientProps {
  ...
  // Desktop specific data props
  symptoms: string[];
  theme: any;
}

// Separate Desktop Component to keep things clean
function DesktopConditionPage({ 
  condition, 
  content, 
  relatedFamilies, 
  symptoms,
    ...
    <>
      <div className="md:hidden">
        <MobileConditionPage 
          ...
          relatedFamilies={props.relatedFamilies}
        />
      </div>
      <div className="hidden md:block">
        <DesktopConditionPage {...props} />
      </div>
    </>
  );
}
