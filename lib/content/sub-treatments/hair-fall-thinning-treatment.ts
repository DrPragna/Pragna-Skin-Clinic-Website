...
export const hairFallThinningTreatmentContent: SubTreatmentContent = {
  hero: {
    title: "Hair Fall & Thinning Treatment",
    tagline: "Slow shedding, protect density",
    intro:
  ...
  quickStats: {
    sessions: "3–6 months structured care",
    duration: "Visits around 20–40 minutes",
    downtime: "No procedural downtime typically",
  ...
  isThisForYou: [
    "You notice widening partition, lighter ponytail or scalp showing clearly in photographs.",
    "Hair fall continues beyond three months after COVID, illness, exam stress or childbirth.",
    "You suspect PCOS or thyroid issues and see more hair on floor daily.",
    "Family members lost hair early and you want to act before thinning advances.",
    "You have tried oils, home remedies and random supplements without clear structure or results.",
  ],
  process: {
    steps: [
      {
        phase: "before",
        title: "Detailed hair assessment",
        description:
      ...
      {
        phase: "after",
        title: "Track response and refine",
        description:
  ...
  faqs: [
    {
      question: "Is all hair fall abnormal and dangerous?",
      answer:
    ...
    {
      question: "Can lost hair grow back completely?",
      answer:
    ...
    {
      question: "Do I need blood tests for hair fall?",
      answer:
    ...
    {
      question: "Will hair oils alone solve my thinning?",
      answer:
    ...
    {
      question: "Is hair transplant the only permanent option?",
      answer:
