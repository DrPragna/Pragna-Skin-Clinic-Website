...
export const moleWartSkinTagRemovalContent: SubTreatmentContent = {
  hero: {
    title: "Mole, Wart & Skin Tag Removal",
    tagline: "Clean removal in medical hands",
    intro:
  ...
  quickStats: {
    sessions: "Often single, sometimes staged",
    duration: "Usually 15–45 minutes",
    downtime: "Crusts, redness, mild soreness",
    painLevel: "Local anaesthesia stings briefly",
  },
  overview:
  ...
  process: {
    steps: [
      {
        phase: "before",
        title: "Evaluate and plan precisely",
        description:
      ...
      {
        phase: "during",
        title: "Remove with chosen technique",
        description:
      ...
      {
        phase: "after",
        title: "Guide wound care and follow-up",
        description:
  ...
  faqs: [
    {
      question: "Are all moles safe to remove cosmetically?",
      answer:
    ...
    {
      question: "Will the mole, wart or tag grow back?",
      answer:
    ...
    {
      question: "Can I do mole removal at a salon or spa?",
      answer:
    ...
    {
      question: "Is local anaesthesia injection very painful?",
      answer:
