...
export const rosaceaFacialRednessContent: ConditionContent = {
  hero: {
  ...
  recommendedTreatments: [
    {
      ...
      bestFor: 'Gentle facials for sensitive, red skin',
    },
    {
      type: 'sub-treatment',
    ...
    },
    {
      ...
      slug: 'chemical-peels',
      name: 'Chemical Peels',
      bestFor: 'Carefully chosen peels for redness-prone skin',
    },
  ],
  timeline: {
    steps: [
  ...
  faqs: [
    {
      question: 'Is rosacea caused by poor hygiene or care?',
      answer:
    ...
    {
      question: 'Can rosacea be completely cured?',
      answer:
    ...
    {
      question: 'Are regular facials suitable for rosacea-prone skin?',
      answer:
    ...
    {
      question: 'Does everyone with rosy cheeks have rosacea?',
      answer:
