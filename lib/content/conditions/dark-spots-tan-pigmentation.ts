...
export const darkSpotsTanPigmentationContent: ConditionContent = {
  hero: {
    title: 'Dark Spots, Tan & Pigmentation',
    empathyStatement:
  ...
  recommendedTreatments: [
    {
      ...
      bestFor: 'Structured care for facial pigmentation',
    },
    {
      type: 'sub-treatment',
      slug: 'pigmentation-dark-spot-treatment',
      name: 'Pigmentation & Dark Spot Treatment',
      bestFor: 'Localised brown spots and patches',
    },
    {
      type: 'sub-treatment',
      slug: 'melasma-treatment',
      name: 'Melasma Treatment',
      bestFor: 'Hormonal, mask-like facial pigmentation',
    },
    {
      type: 'sub-treatment',
      slug: 'tan-removal-brightening',
      name: 'Tan Removal & Brightening',
      bestFor: 'Tan removal and overall brightening',
    },
  ],
  timeline: {
    steps: [
  ...
  faqs: [
    ...
    {
      question: 'Do fairness creams help or harm pigmentation?',
      answer:
    ...
    {
      question: 'How soon can I see results on dark spots?',
      answer:
    ...
    {
      question: 'Are lasers safe for Indian skin with pigmentation?',
      answer:
