 ...
 * 
 * This improves conversion by keeping the primary CTA always accessible.
 */
...
export default function FloatingActions() {
  ...
  const whatsappMessage = encodeURIComponent('Hi, I would like to book a consultation at Pragna Skin Clinic.');
  ...
  return (
    <>
      ...
      <a
        href="/#contact"
        className={`floating-book-btn transition-all duration-500 ${
          shouldShow 
            ? 'translate-y-0 opacity-100' 
            : 'translate-y-20 opacity-0 pointer-events-none'
        }`}
