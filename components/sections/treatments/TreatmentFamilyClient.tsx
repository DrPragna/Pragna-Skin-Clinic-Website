...
interface TreatmentFamilyClientProps {
  family: TreatmentFamily;
  content: any;
  relatedConditions: any[];
}

export default function TreatmentFamilyClient({
  family,
  content,
  relatedConditions
}: TreatmentFamilyClientProps) {
  ...
  return (
    <>
      {/* ============================================
          MOBILE VIEW (CSS-based detection)
          ============================================ */}
      <div className="md:hidden">
        <MobileTreatmentFamily 
          family={family} 
          content={content} 
      ...
      {/* ============================================
          DESKTOP VIEW (CSS-based detection)
          ============================================ */}
              ...
              <div className="grid lg:grid-cols-12 gap-10 items-start">
                ...
                <div className="lg:col-span-8">
                  <div className="grid md:grid-cols-2 gap-x-10 gap-y-6">
                    {whoIsThisForList.map((item: string, i: number) => (
            ...
            <section className="py-10 bg-beige-warm border-t border-charcoal/5">
              <div className="section-container text-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-3">
                  {relatedConditions.map((condition: any, i: number) => (
